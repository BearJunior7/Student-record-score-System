...
import com.example.studentmanagersystem.DatabaseHelper;
import com.example.studentmanagersystem.Query;
...
public class Register extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelper(this, "xcl_db", null, 1);
